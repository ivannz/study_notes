...
An implication $A\to B$ \textbf{follows (semantically)} from a collection $\Lcal$ of implications if every model $T\subseteq M$ of $\Lcal$ is also a model of $A\to B$.

A collection $\Lcal$ of implications is \textbf{closed} if every implication following from $\Lcal$ is contained within $\Lcal$.

% in closed collections of implications
