...
Cite the original papers \cite{jones2004} and \cite{jonesshen2005}.
...
\footnotetext{
The addition $x_0+A$, for $A$ in an affine space such as $\Real$ represents shifting
of every element of the set $A$ by a common value $x_0$.
}
