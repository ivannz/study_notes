...
function is not an $H$-sssi process, but still it exhibits certain self-similarity.
...
continuity implies a certain degree of scale-invariance of the Weierstrass function.
Indeed, for any $a>0$ the condition implies that
...
\end{align*}
which indicates that the Weierstrass function has certain self-similarity.
