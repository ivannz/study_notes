...
\paragraph{Selecting the number of clusters $K$} % (fold)
...
% paragraph selecting_the_number_of_clusters_k (end)
...
\paragraph{Clustering of bipartite graphs} % (fold)
...
% paragraph clustering_of_bipartite_graphs (end)
