...
\begin{figure}[t, width=0.5\textwidth]
  ...
  \begin{subfigure}[b]{\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_gaussian_0,1_0,1_100_5p-GPR_50.png}
    \caption{Sample path with $\gamma=10^{-1}$.} \label{fig:gauss_1d_prof_gpr_high}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_gaussian_1e-06_0,1_100_5p-GPR_50.png}
...
\end{figure}
Obliviously, on the provided illustration (fig.~\ref{fig:gauss_1d_prof_gpr_low}) the
confidence bands on are too wide, whereas the bands in fig.~\ref{fig:gauss_1d_prof_gpr_high}
seem to have better coverage rate. Figure~\ref{fig:gauss_1d_prof_conf} shows sample
conformal confidence bands in the same setting. Near the endpoints of the $[0,1]$, the
confidence regions dramatically increase their size, reflecting increasing uncertainty.
\begin{figure}[b, width=0.5\textwidth]
  \centering
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_gaussian_0,1_0,1_100_5p-CRR_50.png}
    \caption{CRR, $\gamma=10^{-1}$.}
    \label{fig:gauss_1d_prof_conf_high_crr}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_gaussian_0,1_0,1_100_5p-RRCM_50.png}
    \caption{RRCM, $\gamma=10^{-1}$.}
    \label{fig:gauss_1d_prof_conf_high_crr}
  \end{subfigure}
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_gaussian_1e-06_0,1_100_5p-CRR_50.png}
    \caption{CRR, $\gamma=10^{-6}$.}
    \label{fig:gauss_1d_prof_conf_low_crr}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_gaussian_1e-06_0,1_100_5p-RRCM_50.png}
    \caption{RRCM, $\gamma=10^{-6}$.}
    \label{fig:gauss_1d_prof_conf_low_rrcm}
  \end{subfigure}
  \caption{Sample CCR (eq.~\ref{eq:crr_conf_ci}) and RRCM (eq.~\ref{eq:rrcm_conf_ci})
  confidence bands.}
...
is presented in fig.~\ref{fig:gauss_1d_asy_gpr_high_width}, whereas the coverage and
the sizes of conformal confidence intervals are depicted at fig.~\ref{fig:gauss_1d_asy_conf_high}
and fig.~\ref{fig:gauss_1d_asy_conf_high_width}, respectively.
\begin{figure}[b, width=0.5\textwidth]
  \centering
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/GPR-f/coverage_gaussian_0,1_0,1_100_GPR-f.png}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
...
\begin{figure}[b, width=0.5\textwidth]
  \centering
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/coverage_gaussian_0,1_0,1_100_RRCM.png}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/coverage_gaussian_0,1_0,1_100_RRCM-loo.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/coverage_gaussian_0,1_0,1_100_CRR.png}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/coverage_gaussian_0,1_0,1_100_CRR-loo.png}
  \end{subfigure}
...
\begin{figure}[b, width=0.5\textwidth]
  \centering
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/width_gaussian_0,1_0,1_100_RRCM.png}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/width_gaussian_0,1_0,1_100_RRCM-loo.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/width_gaussian_0,1_0,1_100_CRR.png}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/output/exp_1d/gaussian/correct_theta/noise_eq_lambda/0.1_0.1/width_gaussian_0,1_0,1_100_CRR-loo.png}
  \end{subfigure}
...
\end{figure}
Expectedly the GPR confidence intervals indeed uphold their theoretical guarantees.
The illustrations clearly support that the conjectured asymptotic conservative validity
of the conformal confidence regions for all NCMs and residual types as well as their
...
% is that there is not enough variability in the observations, to 

Semi- and non- Gaussian $1$-d settings, fig.~\ref{fig:non_gauss_1d_prof_gpr}.
\begin{figure}[t, width=0.5\textwidth]
  \centering
  \begin{subfigure}[b]{\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_heaviside_0,1_0,1_100_10p-GPR_50.png}
    \caption{Sample path with $\gamma=10^{-1}$.} \label{fig:non_gauss_1d_prof_gpr_high}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_heaviside_1e-06_1e-06_100_10p-GPR_50.png}
    \caption{Sample path with $\gamma=10^{-6}$.} \label{fig:non_gauss_1d_prof_gpr_low}
  \end{subfigure}
  \caption{A sample path of $f(x)+\gamma \epsilon_x$, for $\epsilon_x\sim \Ncal(0,1)$.}
  \label{fig:non_gauss_1d_prof_gpr}
\end{figure}

Sample confidence intervals in the current setting are provided in fig.~\ref{fig:non_gauss_1d_prof_conf}.
\begin{figure}[b, width=0.5\textwidth]
  \centering
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_heaviside_0,1_0,1_100_10p-CRR_50.png}
    \caption{CRR, $\gamma=10^{-1}$.}
    \label{fig:non_gauss_1d_prof_conf_high_crr}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_heaviside_0,1_0,1_100_10p-RRCM_50.png}
    \caption{RRCM, $\gamma=10^{-1}$.}
    \label{fig:non_gauss_1d_prof_conf_high_crr}
  \end{subfigure}
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_heaviside_1e-06_1e-06_100_10p-CRR_50.png}
    \caption{CRR, $\gamma=10^{-6}$.}
    \label{fig:non_gauss_1d_prof_conf_low_crr}
  \end{subfigure}\
  \begin{subfigure}[b]{0.475\linewidth}
    \includegraphics[width=0.9\linewidth]{images/profile/profile_heaviside_1e-06_1e-06_100_10p-RRCM_50.png}
    \caption{RRCM, $\gamma=10^{-6}$.}
...
Typical confidence bands are displayed at fig.~\ref{fig:typical_heaviside} for the
heaviside function. In \cite{burnaevV14} it was proven in the case of ridge regression
that the conformal confidence region is an interval centered around the predicted
value $\hat{y}_{(X,y)}(x^*)$. The confidence regions of all conformal procedures
are very close.
...
Fig.~\ref{fig:typical_1d_f6} shows a typical confidence region for 
