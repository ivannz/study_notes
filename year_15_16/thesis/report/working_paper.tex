...
\preceq I_m$. This means that the matrix $M^{-1}$ defines a non-expanding (in terms
of the Euclidean norm) linear transformation $\Real^{n\times 1} \mapsto \Real^{n\times 1}$.
This shows that the out-of-sample residuals are generally larger than the corresponding
in-sample ones.
