...
\geometry{left=3.5cm} % отступ справа
\geometry{right=2cm}
...
\textsc{Выпускная квалификационная работа магистра }\\[0.7cm]
на тему\\[0.7cm]
\begin{large}
\textsc{\textbf{Пименение конформных процедур с многомерных линейных моделях и детектировании аномалий}}
\end{large}
\end{center}
\vspace{2.5cm}
\begin{center}
...
В настоящей работе рассматривается вопрос сравниваются байесовские доверительные интервалы и конформные процедуры

\textbf{Ключевые слова:} конформные процедуры, ядерные методы, гребневая регрессия,
доверительныне множества, консервативаня валидность;

\selectlanguage{english}
\section*{Abstract}

\textbf{Key words:} conformal prediction, kernel methods, ridge regression,
