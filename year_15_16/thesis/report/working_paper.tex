    ...
    \vbox to \textheight {
        ...
        \begin{center}
	        ...
	        \textbf{%\Large
	            ...
	            кафедра Интеллектуальные Системы и Структурный Анализ\\[2.0cm]}
        ...
        \begin{flushright}
            Выполнил студент группы м14НоД ИССА\\
...
\begin{titlepage}
    ...
    \vbox to \textheight {
        ...
        \begin{center}
            ...
            Department of Intelligent Systems and Structural Analysis\\[2.0cm]}
...
Ridge Regression do not perform worse than the prediction confidence intervals
...
Another possible approaches to endowing LOF with probabilistic scores would be to
use either the empirical distribution of its scores on the train dataset, or conformal
anomaly detection procedures to assign calibrated probability of abnormality, \cite{Laxhammar2014}.
...
we consider the orginal ridge regression approach from \cite{vovk2005}, and in
