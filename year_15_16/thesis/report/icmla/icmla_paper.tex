...
$\Kcal$ (shape, precision et c.). Other approaches to estimating the covariance function's
hyper-parameters are given in \cite{Burnaev2014}, \cite{Zaitsev2013}, \cite{Belyaev2016},
\cite{Burnaev2016}, and \cite{Belyaev2015}.
...
due to independence of $Z_{:n}$ (for a rigorous proof see \cite{vovk2005}, chapter 8).
...
are defined for each $i=1,\ldots, n$ as
