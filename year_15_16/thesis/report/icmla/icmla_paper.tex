...
If the variance is estimated form the training data and the final distribution,
...
Finally, an observation is considered anomalous if it suffers large reconstruction
error.
